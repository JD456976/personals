    ...
    <div class="navbar-container d-flex content mt-2 mb-1">
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item d-none d-lg-block"><a href="{{ route('contact')}}" class="nav-link">Contact</a>
                ...
                <li class="nav-item d-none d-lg-block"><a href="{{ route('home') }}" class="nav-link">Main Site</a>
                </li>
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                                                           id="dropdown-user" href="#" data-bs-toggle="dropdown"
                                                           aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span style="margin-top: 5px" class="user-name fw-bolder">{{ Auth::user()->email }}</span></div>
